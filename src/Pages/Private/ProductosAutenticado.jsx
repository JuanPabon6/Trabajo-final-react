...
export const ProductosAutenticado = () => {
  ...
  const productosFiltrados = categoriaSeleccionada
    ...
    const vovler = () =>{ navigate("/LandingAutenticada")}

  return (
    <>
      <section className="mt-20 px-6">
        <button onClick={vovler} className="px-4 py-2 bg-blue-600 text-white rounded-lg shadow hover:bg-blue-700 transition">⬅️ Volver</button>
